...
export const dtLightTheme = createTheme(color, {
  Background: {
    Container: '#FDF0F3',
    ContainerHover: '#FAE4EA',
    ContainerActive: '#F5D2DB',
    ContainerLine: '#EDB5C0',
    OnContainer: '#3D1F28',
  },
  Surface: {
    Container: '#FFF7F9',
    ContainerHover: '#FDF0F3',
    ContainerActive: '#FAE4EA',
    ContainerLine: '#EDB5C0',
    OnContainer: '#3D1F28',
  },
  SurfaceVariant: {
    Container: '#FAE4EA',
    ContainerHover: '#F5D2DB',
    ContainerActive: '#EFC0CC',
    ContainerLine: '#E8A8B8',
    OnContainer: '#6B3D4E',
  },
  Primary: {
    Main: '#E8829F',
  ...
  Secondary: {
    ...
    OnMain: '#FFFFFF',
    Container: '#F5EDE0',
    ContainerHover: '#EDE0CC',
    ContainerActive: '#E4D2B8',
    ContainerLine: '#DBC4A4',
    OnContainer: '#5C3D1E',
  },
  Success: {
    Main: '#017343',
  ...
  Other: {
    FocusRing: 'rgba(232, 130, 159, 0.5)',
    Shadow: 'rgba(107, 61, 78, 0.2)',
    Overlay: 'rgba(61, 31, 40, 0.5)',
  },
});
