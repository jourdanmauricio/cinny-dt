      ...
      <OverlayCenter>
        ...
        >
          <Dialog variant="Surface">
            ...
            >
              <Box grow="Yes">
                <Text size="H4">Ir a fecha/hora</Text>
              </Box>
            ...
            <Box style={{ padding: config.space.S400 }} direction="Column" gap="500">
              ...
              <Box direction="Column" gap="100">
                <Text size="L400">Acceso rápido</Text>
                <Box gap="200">
                  {createTs < todayTs && (
                    <Chip
              ...
              >
                <Text size="B400">Abrir cronología</Text>
              </Button>
            </Box>
          </Dialog>
        </FocusTrap>
