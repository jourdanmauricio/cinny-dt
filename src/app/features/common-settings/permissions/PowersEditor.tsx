            ...
            <Box direction="Column" gap="700">
              <Box direction="Column" gap="100">
                <Box alignItems="Baseline" gap="200" justifyContent="SpaceBetween">
                  <Text size="L400">Niveles de poder</Text>
                  <BetaNoticeBadge />
                </Box>
                <SequenceCard
                ...
                >
                  <SettingTile
                    title="Nuevo nivel de poder"
                    description="Crear un nuevo nivel de poder."
                    after={
                      !createTag && (
                        <Button
                                        ...
                                        <Tooltip style={{ maxWidth: toRem(200) }}>
                                          {usedPowers.has(power) ? (
                                            <Box direction="Column">
                                              <Text size="L400">Nivel de poder en uso</Text>
                                              <Text size="T200">
                                                Debes eliminar su uso antes de poder borrarlo.
                                              </Text>
                                            </Box>
                                          ) : (
                                            <Text>Eliminar</Text>
