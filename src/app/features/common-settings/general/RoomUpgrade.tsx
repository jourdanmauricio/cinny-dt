      ...
      <OverlayCenter>
        ...
        >
          <Dialog variant="Surface">
            ...
            >
              <Box grow="Yes">
                <Text size="H4">{room.isSpaceRoom() ? 'Actualizar espacio' : 'Actualizar sala'}</Text>
              </Box>
            ...
            <Box style={{ padding: config.space.S400 }} direction="Column" gap="400">
              ...
              >
                <Text size="B400">{room.isSpaceRoom() ? 'Actualizar espacio' : 'Actualizar sala'}</Text>
              </Button>
            </Box>
          </Dialog>
        </FocusTrap>
...
export function RoomUpgrade({ permissions, requestClose }: RoomUpgradeProps) {
  ...
  return (
    ...
    >
      <SettingTile
        title={room.isSpaceRoom() ? 'Actualizar espacio' : 'Actualizar sala'}
        description={
          replacementRoom
        ...
        after={
          <Box alignItems="Center" gap="200">
            {predecessorRoomId && (
              ...
              >
                <Text size="B300">{room.isSpaceRoom() ? 'Espacio anterior' : 'Sala anterior'}</Text>
              </Button>
            )}
            {replacementRoom ? (
              <Button
              ...
              >
                <Text size="B300">{room.isSpaceRoom() ? 'Abrir espacio nuevo' : 'Abrir sala nueva'}</Text>
              </Button>
            ) : (
              <Button
                size="300"
              ...
              >
                <Text size="B300">Actualizar</Text>
              </Button>
            )}
          </Box>
        }
