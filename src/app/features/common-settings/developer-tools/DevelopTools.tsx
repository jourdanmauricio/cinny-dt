          ...
          <PageContent>
            <Box direction="Column" gap="700">
              <Box direction="Column" gap="100">
                ...
                >
                  <SettingTile
                    title="Activar herramientas de desarrollador"
                    after={
                      <Switch
                        variant="Primary"
                ...
                {developerTools && (
                  ...
                  >
                    <SettingTile
                      title="ID de sala"
                      description={`Copiar ID de sala al portapapeles ("${room.roomId}").`}
                      after={
                        <Button
              ...
              {developerTools && (
                <Box direction="Column" gap="100">
                  ...
                  >
                    <SettingTile
                      title="Nuevo evento de mensaje"
                      description="Crear y enviar un nuevo evento de mensaje en la sala."
                      after={
                        <Button
                  ...
                  >
                    <SettingTile
                      title="Estado de la sala"
                      description="Eventos de estado de la sala."
                      after={
                        <Button
                        ...
                        >
                          <Text size="B300">{expandState ? 'Contraer' : 'Expandir'}</Text>
                        </Button>
                      }
                    />
                    {expandState && (
                                      ...
                                      {Array.from(stateKeyToEvents.keys())
                                        ...
                                        .map((stateKey) => (
                                          ...
                                          >
                                            <Box grow="Yes">
                                              <Text size="T200" truncate>
                                                {stateKey ? `"${stateKey}"` : 'Predeterminado'}
                                              </Text>
                                            </Box>
                                          </MenuItem>
                                        ))}
                  ...
                  >
                    <SettingTile
                      ...
                      description="Datos privados de personalización almacenados en la sala."
                      after={
                        <Button
                        ...
                        >
                          <Text size="B300">{expandAccountData ? 'Contraer' : 'Expandir'}</Text>
                        </Button>
                      }
                    />
                    {expandAccountData && (
