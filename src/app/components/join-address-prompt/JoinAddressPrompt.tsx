      ...
      <OverlayCenter>
        ...
        >
          <Dialog variant="Surface">
            ...
            >
              <Box grow="Yes">
                <Text size="H4">Unirse con dirección</Text>
              </Box>
            ...
            >
              <Box direction="Column" gap="200">
                <Text priority="400" size="T300">
                  Ingresa una dirección pública para unirte a la comunidad. Las direcciones tienen el formato:
                </Text>
