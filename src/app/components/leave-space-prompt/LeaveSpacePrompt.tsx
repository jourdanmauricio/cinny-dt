      ...
      <OverlayCenter>
        ...
        >
          <Dialog variant="Surface">
            ...
            >
              <Box grow="Yes">
                <Text size="H4">Salir del espacio</Text>
              </Box>
            ...
            <Box style={{ padding: config.space.S400 }} direction="Column" gap="400">
              <Box direction="Column" gap="200">
                <Text priority="400">¿Seguro que quieres salir de este espacio?</Text>
                {leaveState.status === AsyncStatus.Error && (
                  <Text style={{ color: color.Critical.Main }} size="T300">
                    No se pudo salir del espacio. {leaveState.error.message}
                  </Text>
                )}
              </Box>
              <Button
              ...
              >
                <Text size="B400">
                  {leaveState.status === AsyncStatus.Loading ? 'Saliendo...' : 'Salir'}
                </Text>
              </Button>
            </Box>
          </Dialog>
