      ...
      <SettingTile>
        <Box direction="Column" gap="200">
          <Box gap="200" justifyContent="SpaceBetween">
            <Text size="L400">Usuario expulsado</Text>
            {time && date && (
              <Text size="T200">
                {date} {time}
              </Text>
  ...
  return (
    <CutoutCard style={{ padding: config.space.S200 }} variant="Critical">
      <SettingTile>
        <Box direction="Column" gap="200">
          <Box gap="200" justifyContent="SpaceBetween">
            <Text size="L400">Usuario bloqueado</Text>
            {time && date && (
              <Text size="T200">
                {date} {time}
              </Text>
          ...
          {canUnban && (
            <Button
              ...
              disabled={banning}
            >
              <Text size="B300">Desbloquear</Text>
            </Button>
          )}
        </Box>
      </SettingTile>
  ...
  return (
    <CutoutCard style={{ padding: config.space.S200 }} variant="Success">
      <SettingTile>
        <Box direction="Column" gap="200">
          <Box gap="200" justifyContent="SpaceBetween">
            <Text size="L400">Usuario invitado</Text>
            {time && date && (
              <Text size="T200">
                {date} {time}
              </Text>
          ...
          {canKick && (
            <Button
              ...
              disabled={kicking}
            >
              <Text size="B300">Cancelar invitación</Text>
            </Button>
          )}
        </Box>
      </SettingTile>
    ...
    <Box direction="Column" gap="400">
      <Box direction="Column" gap="200">
        <Box grow="Yes" direction="Column" gap="100">
          <Text size="L400">Moderación</Text>
          <Input
            ref={reasonInputRef}
            placeholder="Motivo"
            size="300"
